    ...
    <section id="about" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 ref={titleRef} className="text-4xl sm:text-5xl font-bold text-dark mb-6">Our Mission</h2>
          <div className="w-24 h-1 bg-primary mx-auto mb-8"></div>
          <p ref={descRef} className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
          <div ref={value1Ref} className="text-center group">
          ...
          <div ref={value2Ref} className="text-center group">
            <div className="w-16 h-16 bg-secondary rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200">
          ...
          <div ref={value3Ref} className="text-center group">
          ...
          <div ref={value4Ref} className="text-center group">
            <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-200">
